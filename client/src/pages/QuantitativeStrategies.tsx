...
import PythonChart from "@/components/PythonChart";
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold mb-4">Live Strategy Analytics</h3>
            <p className="text-lg text-primary/70 max-w-3xl mx-auto">
              Real-time analysis powered by our proprietary Python quantitative models. These charts are generated directly 
              from our live trading algorithms and updated dynamically.
            </p>
          </div>
          ...
          <div className="space-y-8">
            ...
            <PythonChart
              scriptName="portfolio_performance"
              title="Quantitative Alpha Strategy - Live Performance"
              description="Real-time performance analysis of our multi-factor equity strategy vs benchmark"
              autoExecute={true}
            />

            {/* Market Correlation Analysis */}
            <PythonChart
              scriptName="market_correlation"
              title="Multi-Asset Correlation Matrix"
              description="Dynamic correlation analysis across major asset classes for portfolio diversification"
              autoExecute={true}
            />
          </div>

          <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-6">
            <h4 className="font-semibold text-blue-900 mb-3">About These Analytics</h4>
            <p className="text-blue-800 text-sm leading-relaxed">
              These charts are generated by our production Python quantitative models that power our real strategies. 
              The data includes live performance metrics, risk analytics, and correlation matrices updated in real-time. 
              Each analysis includes detailed methodology explanations and model quality assessments to provide full transparency 
              into our investment process and model performance.
            </p>
          </div>
        </motion.div>
      </div>
