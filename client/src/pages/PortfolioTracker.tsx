      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        >
          ...
          <p className="text-gray-600 mb-8">
            Monitor and analyze your investment performance with real-time
            analytics.
          </p>
          ...
          <Card className="p-12 text-center bg-white">
            <h3 className="text-xl font-semibold mb-4">
              Interactive Portfolio Analysis Coming Soon
            </h3>
            <p className="text-gray-500 max-w-2xl mx-auto">
              We are currently integrating our advanced quantitative engine with
              personal portfolio tracking. Soon you will be able to upload your
              holdings and see how ChironHedge models would optimize your
